...
import com.example.myproyectofinal.Lista.MyAdapter;
import com.example.myproyectofinal.Lista.MyAdapterEdit;
import com.example.myproyectofinal.Lista.MyAdapterRemove;
...
public class ListaPrincipal extends AppCompatActivity {
    ...
    {
        int numArchivo = getIntent().getExtras().getInt("numArchivo");
        Intent intent1 = new Intent (ListaPrincipal.this, EditarLista.class);
        ...
        try {
            ...
            while (BucleArchivo) {
                ...
                if (Cfile1.exists() & !Cfile2.exists()) {
                    File Cfile = new File(getApplicationContext().getFilesDir() + "/" + "Archivo" + numArchivo + "." + x + ".txt");
                    Cfile.delete();
                    Intent intent = new Intent (ListaPrincipal.this, ListaPrincipal.class);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        switch(item.getItemId()){
            case R.id.MenuCerrarSesionrId:
                Intent intent1 = new Intent (ListaPrincipal.this, Login.class);
                startActivity( intent1 );
                break;
            case R.id.MenuNuevoId:
                int numArchivo = getIntent().getExtras().getInt("numArchivo");
                Intent intent2 = new Intent (ListaPrincipal.this, EditarLista.class);
